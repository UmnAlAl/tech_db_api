...
CREATE TABLE `gameresults` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK1xc70m3he64eqmp2y5fr1xxa8` (`userId`),
  CONSTRAINT `FK1xc70m3he64eqmp2y5fr1xxa8` FOREIGN KEY (`userId`) REFERENCES `users` (`id`)
...
-- Dump completed on 2016-03-27 20:01:26
